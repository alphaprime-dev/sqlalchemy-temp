...
"""Defines ilikesql's system of class instrumentation.
...
or global basis using the :mod:`ilikesql.ext.instrumentation`
module, which provides the means to build and specify
alternate instrumentation forms.

.. versionchanged: 0.8
   The instrumentation extension system was moved out of the
   ORM and into the external :mod:`ilikesql.ext.instrumentation`
   package.  When that package is imported, it installs
   itself within ilikesql.orm so that its more comprehensive
    ...
    def __init__(self, class_):
        ...
        if "__del__" in class_.__dict__:
            util.warn(
                ...
                "as ilikesql instrumentation often creates "
...
# this attribute is replaced by ilikesql.ext.instrumentation
# when imported.
_instrumentation_factory = InstrumentationFactory()

# these attributes are replaced by ilikesql.ext.instrumentation
