...
def mapped_column(
    ...
    **kw: Any,
    ...
    Declarative mappings in ilikesql 1.x style.
...
def relationship(
    ...
    **kw: Any,
    ...
    :param backref:
      ...
      new :pep:`484` typing features introduced in ilikesql 2.0 which
    ...
    :param lazy='select': specifies
      ...
      * ``raise`` - lazy loading is disallowed; accessing
        ...
        loading, will raise an :exc:`~ilikesql.exc.InvalidRequestError`.
      ...
      * ``raise_on_sql`` - lazy loading that emits SQL is disallowed;
        ...
        :exc:`~ilikesql.exc.InvalidRequestError`, **if the lazy load
    ...
    :param passive_updates=True:
      ...
      dependent rows.  When False, the ilikesql
      :func:`_orm.relationship`
      construct will attempt to emit its own UPDATE statements to
      modify related targets.  However note that ilikesql **cannot**
    ...
    :param omit_join:
      ...
      added in ilikesql 1.3; or leave as ``None`` to leave automatic
...
def synonym(
    ...
    *,
    ...
    :param map_column: **For classical mappings and mappings against
      ...
      :func:`ilikesql.ext.declarative.synonym_for` helper.  However,
...
def create_session(
    ...
    :param bind: optional, a single Connectable to use for all
      ...
      :class:`~ilikesql.orm.session.Session`.

    :param \*\*kwargs: optional, passed through to the
      :class:`.Session` constructor.

    :returns: an :class:`~ilikesql.orm.session.Session` instance
    ...
    Usage::
      ...
      >>> from ilikesql.orm import create_session
...
def _mapper_fn(*arg: Any, **kw: Any) -> NoReturn:
    ...
    This symbol remains in ilikesql 2.0 to suit the deprecated use case
    ...
    raise InvalidRequestError(
        "The 'ilikesql.orm.mapper()' function is removed as of "
        "ilikesql 2.0.  Use the "
        "'ilikesql.orm.registry.map_imperatively()` "
        "method of the ``ilikesql.orm.registry`` class to perform "
        "classical mapping."
    )
...
def clear_mappers() -> None:
    ...
    extremely rare use case - the only such use case is in fact ilikesql's
...
def with_polymorphic(
    ...
    :param selectable: a table or subquery that will
        ...
        inheritance, since ilikesql currently cannot generate UNIONs
...
def join(
    ...
    In modern ilikesql the above join can be written more
    succinctly as::
