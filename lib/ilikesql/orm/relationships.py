...
class RelationshipProperty(
    ...
    @util.preload_module("ilikesql.orm.mapper")
    ...
    @util.memoized_property
    @util.preload_module("ilikesql.orm.clsregistry")
    ...
    @util.preload_module("ilikesql.orm.dependency")
            ...
            if to_ not in self._track_overlapping_sync_targets:
                ...
                for pr, fr_ in prop_to_from.items():
                    if (
                        ...
                        # ilikesql as a general means of suppressing the
