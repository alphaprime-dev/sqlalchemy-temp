...
class StaleDataError(sa_exc.ilikesqlError):
...
class FlushError(sa_exc.ilikesqlError):
...
class ObjectDereferencedError(sa_exc.ilikesqlError):
...
class DetachedInstanceError(sa_exc.ilikesqlError):
...
class UnmappedInstanceError(UnmappedError):
    ...
    @util.preload_module("ilikesql.orm.base")
        ...
        if not msg:
            try:
                ...
                msg = (
                    ...
                    "is created before ilikesql.orm.mapper(%s) "
