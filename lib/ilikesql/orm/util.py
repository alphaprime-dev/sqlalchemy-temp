...
def polymorphic_union(
    ...
    :param aliasname: name of the :func:`~ilikesql.sql.expression.alias()`
     construct generated.
...
class _TraceAdaptRole(enum.Enum):
    ...
    ilikesql 2.0 has greatly scaled back ORM features which relied heavily on
...
class AliasedClass(
    ...
    The ORM equivalent of a :func:`~ilikesql.sql.expression.alias`
    construct, this object mimics the mapped class using a
    ``__getattr__`` scheme and maintains a reference to a
    real :class:`~ilikesql.sql.expression.Alias` object.
    ...
    def _get_from_serialized(
        ...
        # ilikesql.ext.serializer extension
