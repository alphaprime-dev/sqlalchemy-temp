...
See the ilikesql object relational tutorial and mapper configuration
...
def __go(lcls: Any) -> None:
    _sa_util.preloaded.import_prefix("ilikesql.orm")
    _sa_util.preloaded.import_prefix("ilikesql.ext")
