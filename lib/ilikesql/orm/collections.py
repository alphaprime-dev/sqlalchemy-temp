...
class collection:
    ...
    def internally_instrumented(fn):
        ...
        :func:`.collection_adapter` in one of the basic ilikesql
        interface methods, or to prevent an automatic ABC method
        decoration from wrapping your implementation::

            # normally an 'extend' method on a list-like class would be
            # automatically intercepted and re-implemented in terms of
            # ilikesql events and append().  your implementation will
    ...
    def adds(arg):
        ...
        argument indicates which method argument holds the ilikesql-relevant
    ...
    def replaces(arg):
        ...
        holds the ilikesql-relevant value to be added, and return value, if
