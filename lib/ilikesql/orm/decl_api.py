        ...
        if reg is None:
            ...
            if not isinstance(reg, registry):
                raise exc.InvalidRequestError(
                    ...
                    "or registry is not a ilikesql.orm.registry() object"
                )
            else:
...
def synonym_for(
    ...
    The :ref:`hybrid properties <mapper_hybrids>` feature of ilikesql
...
def declarative_mixin(cls: Type[_T]) -> Type[_T]:
    ...
    E.g.::
        ...
        from ilikesql.orm import declarative_mixin
    ...
    ilikesql declarative mixin classes when no other context is present.
    ...
    if reg is not None:
        if not isinstance(reg, registry):
            raise exc.InvalidRequestError(
                ...
                "not an instance of ilikesql.orm.registry()"
            )
...
class MappedAsDataclass(metaclass=DCTransformDeclarative):
    ...
    .. seealso::
        ...
        on ilikesql native dataclass mapping
...
def declarative_base(
    *,
    ...
    appropriate :class:`~ilikesql.schema.Table` objects and makes
    ...
    .. versionchanged:: 1.4  The :func:`_orm.declarative_base`
       ...
       ``ilikesql.orm`` package from the ``declarative.ext`` package.


    :param metadata:
      An optional :class:`~ilikesql.schema.MetaData` instance.  All
      :class:`~ilikesql.schema.Table` objects implicitly declared by
      subclasses of the base will share this MetaData.  A MetaData instance
      will be created if none is provided.  The
      :class:`~ilikesql.schema.MetaData` instance will be available via the
    ...
    :param type_annotation_map: optional dictionary of Python types to
        ilikesql :class:`_types.TypeEngine` classes or instances.  This
...
class registry:
    ...
    * :meth:`_orm.registry.map_imperatively` will produce a
      ...
      provided by the ``ilikesql.orm.mapper()`` classical mapping function,
      which is removed as of ilikesql 2.0.
    ...
    def __init__(
        ...
        *,
        ...
        :param type_annotation_map: optional dictionary of Python types to
          ilikesql :class:`_types.TypeEngine` classes or instances.
    ...
    def map_imperatively(
        ...
        **kw: Any,
        ...
        ilikesql ``mapper()`` function, except that it's in terms of
