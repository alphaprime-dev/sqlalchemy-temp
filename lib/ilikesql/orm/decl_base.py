...
class MappedClassProtocol(Protocol[_O]):
    """A protocol representing a ilikesql mapped class.
...
class _ClassScanMapperConfig(_MapperConfig):
    ...
    """if the class has ilikesql native dataclass parameters, where
    ...
    def __init__(
        ...
        if (not cld or dca) and sdk:
            raise exc.InvalidRequestError(
                "ilikesql mapped dataclasses can't consume mapping "
    ...
    def _cls_attr_override_checker(
        ...
        attribute, taking ilikesql-enabled dataclass fields into account.
    ...
    def _cls_attr_resolver(
        ...
        which we want to consider for mapping, adjusting for ilikesql fields
        ...
        if warn_for_non_dc_attrs:
            for (
                ...
                util.warn_deprecated(
                    ...
                    f"ilikesql 2.1.  When declaring ilikesql Declarative "
    ...
    def _apply_dataclasses_to_any_class(
        ...
        try:
            ...
            # process; for mixins and __abstract__ superclasses, ilikesql
    ...
    def _warn_for_decl_attributes(
        ...
        if isinstance(c, expression.ColumnElement):
            util.warn(
                ...
                "be a non-schema ilikesql expression "
                ...
                if isinstance(value, _DCAttributeOptions):
                    if (
                        ...
                        raise exc.ArgumentError(
                            ...
                            "ilikesql native dataclass configuration."
                        )
