...
class ColumnProperty(
    ...
    @util.preload_module("ilikesql.orm.state", "ilikesql.orm.strategies")
...
class MappedColumn(
    ...
    @util.preload_module("ilikesql.orm.decl_base")
            ...
            for check_type in checks:
                ...
                if isinstance(our_type, TypeEngine) or (
                    ...
                    raise sa_exc.ArgumentError(
                        ...
                        "attribute Mapped annotation is the ilikesql type "
                        f"{our_type}. Expected a Python type instead"
                    )
                else:
                    raise sa_exc.ArgumentError(
                        "Could not locate ilikesql Core type for Python "
