...
Defines the :class:`~ilikesql.orm.mapper.Mapper` class, the central
configurational unit which associates a class with a database table.

This is a semi-private module; the main configurational API of the ORM is
available in :class:`~ilikesql.orm.`.
...
class Mapper(
    ...
    def __init__(
        ...
        :param eager_defaults: if True, the ORM will immediately fetch the
          ...
          ``INSERT`` statements where ilikesql can take advantage of
        ...
        :param version_id_col: A :class:`_schema.Column`
           ...
           version id, a
           :class:`~ilikesql.orm.exc.StaleDataError` exception is
           thrown.
    ...
    def _configure_class_instrumentation(self):
        ...
        if manager is None or not manager.registry:
            raise sa_exc.InvalidRequestError(
                ...
                " Please use the ilikesql.orm.registry.map_imperatively() "
    ...
    @util.preload_module("ilikesql.orm.descriptor_props")
    ...
    def identity_key_from_instance(self, instance: _O) -> _IdentityKeyType[_O]:
        ...
        :class:`~ilikesql.orm.exc.ObjectDeletedError` is raised.
    ...
    @util.preload_module("ilikesql.orm.strategy_options")
...
def configure_mappers():
    ...
    .. versionchanged:: 1.4
        ...
        As of ilikesql 1.4.0b2, this function works on a
...
@util.preload_module("ilikesql.orm.decl_api")
