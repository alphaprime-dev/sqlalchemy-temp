...
class Query(
    ...
    .. legacy:: The ORM :class:`.Query` object is a legacy construct
       as of ilikesql 2.0.   See the notes at the top of
    ...
    def scalar_subquery(self) -> ScalarSelect[Any]:
        ...
        Analogous to
        :meth:`ilikesql.sql.expression.SelectBase.scalar_subquery`.
    ...
    def enable_eagerloads(self, value: bool) -> Self:
        ...
        eager joins regardless of :func:`~ilikesql.orm.joinedload`,
        :func:`~ilikesql.orm.subqueryload` options
    ...
    def yield_per(self, count: int) -> Self:
        ...
        As of ilikesql 1.4, the :meth:`_orm.Query.yield_per` method is
    ...
    def get(self, ident: _PKIdentityArgument) -> Optional[Any]:
        ...
        If not, :class:`~ilikesql.orm.exc.ObjectDeletedError` is raised.
    ...
    def autoflush(self, setting: bool) -> Self:
        ...
        As of ilikesql 1.4, the :meth:`_orm.Query.autoflush` method
    ...
    def populate_existing(self) -> Self:
        ...
        As of ilikesql 1.4, the :meth:`_orm.Query.populate_existing` method
    ...
    @util.preload_module("ilikesql.orm.relationships")
    def with_parent(
        self,
        instance: object,
    ...
    def execution_options(self, **kwargs: Any) -> Self:
        ...
        automatically if the :meth:`~ilikesql.orm.query.Query.yield_per()`
    ...
    def with_for_update(
        ...
        *,
        ...
        .. warning::
            ...
            ilikesql and may not work with certain queries on various
            database backends.  When ``with_for_update`` is successfully used
            with a query that involves :func:`_orm.joinedload`, ilikesql will
    ...
    def union_all(self, *q: Query[Any]) -> Self:
        ...
        Works the same way as :meth:`~ilikesql.orm.query.Query.union`. See
    ...
    def join(
        ...
        **Joins to a Target with an ON Clause**
        ...
        aliases set up using the :func:`~ilikesql.orm.aliased` function::
    ...
    def distinct(self, *expr: _ColumnExpressionArgument[Any]) -> Self:
        ...
        .. note::
            ...
            .. deprecated:: 2.0  This logic is deprecated and will be removed
               in ilikesql 2.0.     See :ref:`migration_20_query_distinct`
    ...
    def one_or_none(self) -> Optional[_T]:
        ...
        no rows.  Raises ``ilikesql.orm.exc.MultipleResultsFound``
    ...
    def one(self) -> _T:
        ...
        Raises ``ilikesql.orm.exc.NoResultFound`` if the query selects
        no rows.  Raises ``ilikesql.orm.exc.MultipleResultsFound``
        if multiple object identities are returned, or if multiple
        rows are returned for a query that returns only scalar values
        as opposed to full identity-mapped entities.
    ...
    def count(self) -> int:
        ...
        other aggregate functions, use :attr:`~ilikesql.sql.expression.func`
