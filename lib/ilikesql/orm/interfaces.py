...
# use of ilikesql.util.typing.DescriptorReference to avoid mis-interpretation
# by typing tools
...
class PropComparator(SQLORMOperations[_T], Generic[_T], ColumnOperators):
    ...
    ilikesql allows for operators to
    ...
    the appropriate subclass of :class:`.PropComparator` should be used::
        ...
        from ilikesql.orm.properties import \
                                ColumnProperty,\
                                Composite,\
                                Relationship
        ...
        from ilikesql.orm import column_property, relationship, composite
        from ilikesql import Column, String
