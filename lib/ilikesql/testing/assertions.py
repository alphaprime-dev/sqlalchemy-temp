...
def expect_warnings(*messages, **kw):
    ...
    ilikesql.util.warn and ilikesql.util.warn_limited.   Otherwise
...
def uses_deprecated(*messages):
    ...
    verbiage emitted by the ilikesql.util.deprecated decorator.
...
def _expect_warnings_sqla_only(
    ...
    """ilikesql internal use only _expect_warnings().
