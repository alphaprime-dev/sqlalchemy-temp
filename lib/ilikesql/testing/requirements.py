...
class SuiteRequirements(Requirements):
    ...
    def table_value_constructor(self):
        ...
        ilikesql generates this with the :func:`_sql.values` function.
    ...
    def numeric_received_as_decimal_untyped(self):
        ...
        or ints, including when no ilikesql-side typing information is
    ...
    @property
    def ilikesql2_stubs(self):
        def check(config):
            try:
                __import__("ilikesql-stubs.ext.mypy")
            except ImportError:
                return False
            else:
                return True
