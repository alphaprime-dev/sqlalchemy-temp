...
libraries, mainly external ilikesql and Alembic dialects, to make use
of the same test environment and standard suites available to
ilikesql/Alembic themselves without the need to ship/install a separate
package outside of ilikesql.
...
if to_bootstrap == "pytest":
    ...
    sys.modules["sqla_plugin_base"].bootstrapped_as_ilikesql = True
