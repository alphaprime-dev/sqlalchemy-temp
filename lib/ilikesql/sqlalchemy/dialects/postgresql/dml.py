...
def insert(table):
    ...
    .. container:: inherited_member
        ...
        The :func:`ilikesql.dialects.postgresql.insert` function creates
        a :class:`ilikesql.dialects.postgresql.Insert`.  This class is based
...
class Insert(StandardInsert):
    ...
    :func:`ilikesql.dialects.postgresql.insert` function.
