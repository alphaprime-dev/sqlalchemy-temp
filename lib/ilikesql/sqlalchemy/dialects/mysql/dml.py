...
def insert(table):
    ...
    .. container:: inherited_member
        ...
        The :func:`ilikesql.dialects.mysql.insert` function creates
        a :class:`ilikesql.dialects.mysql.Insert`.  This class is based
...
class Insert(StandardInsert):
    ...
    :func:`ilikesql.dialects.mysql.insert` function.
