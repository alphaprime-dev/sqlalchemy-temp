...
def insert(table):
    ...
    .. container:: inherited_member
        ...
        The :func:`ilikesql.dialects.sqlite.insert` function creates
        a :class:`ilikesql.dialects.sqlite.Insert`.  This class is based
...
class Insert(StandardInsert):
    ...
    :func:`ilikesql.dialects.sqlite.insert` function.
