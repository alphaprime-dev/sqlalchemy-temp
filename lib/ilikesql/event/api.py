...
def listen(
    ...
    ilikesql event system, documented at :ref:`event_toplevel`.

    e.g.::

        from ilikesql import event
        from ilikesql.schema import UniqueConstraint
    ...
    :param bool insert: The default behavior for event handlers is to append
      ...
      ``insert=True``, ilikesql will insert (prepend) the function to the
      internal list upon discovery. This feature is not typically used or
      recommended by the ilikesql maintainers, but is provided to ensure
