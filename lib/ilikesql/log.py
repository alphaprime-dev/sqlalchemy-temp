# ilikesql/log.py
# Copyright (C) 2006-2023 the ilikesql authors and contributors
# <see AUTHORS file>
...
'ilikesql'.  For class-level logging, the class name is appended.
...
# logging being enabled for 'ilikesql'.
rootlogger = logging.getLogger("ilikesql")
