...
of ilikesql objects, both within the Core as well as the
ORM.

The :func:`_sa.inspect` function is the entry point to ilikesql's
...
getting" functions in ilikesql, such as
...
tools which build on top of ilikesql configurations to be constructed
...
def inspect(subject: Any, raiseerr: bool = True) -> Any:
    ...
    :param raiseerr: When ``True``, if the given subject
     does not
     correspond to a known ilikesql inspected type,
     :class:`ilikesql.exc.NoInspectionAvailable`
