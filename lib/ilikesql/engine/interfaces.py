...
class ReflectedColumn(TypedDict):
    ...
    flag of some kind.   Within ilikesql, other kinds of columns may
...
class BindTyping(Enum):
    ...
    the ilikesql dialect has the appropriate infrastructure for that
...
class Dialect(EventTarget):
    ...
    ilikesql dialects import DBAPI modules using the classmethod
    ...
    True for ilikesql internal dialects SQLite, MySQL/MariaDB, PostgreSQL,
    ...
    """A dictionary of TypeEngine classes from ilikesql.types mapped
    ...
    """Optional set of argument specifiers for various ilikesql
    ...
    it.  ilikesql tests that this flag is locally present on each dialect
    ...
    def initialize(self, connection: Connection) -> None:
        ...
        The connection passed here is a ilikesql Connection object,
        with full capabilities.

        The initialize() method of the base dialect should be called via
        super().

        .. note:: as of ilikesql 1.4, this method is called **before**
    ...
    def has_table(
        ...
        **kw: Any,
        ...
        .. note:: This method is used internally by ilikesql, and is
    ...
    def do_set_input_sizes(
        ...
        ilikesql type. The order of tuples is in the correct parameter order.
...
class CreateEnginePlugin:
    ...
    * connectivity plugins such as proxies
    ...
    As of version 1.4 of ilikesql, arguments should continue to be consumed
...
class ExecutionContext:
    ...
    """if passed to constructor, ilikesql.engine.base.Compiled object
      being executed"""
    ...
    def get_out_parameter_values(
        ...
        previous ilikesql versions, the values can be the **raw values** from
        ...
        ilikesql 1.4 has multiple kinds of result object as part of the 2.0
        transition.
...
class ExceptionContext:
    ...
    ilikesql_exception: Optional[StatementError]
    """The :class:`ilikesql.exc.StatementError` which wraps the original,
    and will be raised if exception handling is not circumvented by the event.

    May be None, as not all exception types are wrapped by ilikesql.
    ...
    ilikesql unless a subsequent handler replaces it.
    ...
    ilikesql will defer to this flag in order to determine whether or not
