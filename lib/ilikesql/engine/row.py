...
if TYPE_CHECKING or not HAS_CYEXTENSION:
    ...
    from ilikesql.cyextension.resultproxy import BaseRow as BaseRow
...
class Row(BaseRow, Sequence[Any], Generic[_TP]):
    ...
    typically associated in the 1.x series of ilikesql with the
    :class:`_engine.CursorResult` object, however is also used by the ORM for
    tuple-like results as of ilikesql 1.4.
