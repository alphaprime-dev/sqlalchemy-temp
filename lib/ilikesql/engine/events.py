...
class ConnectionEvents(event.Events[ConnectionEventsTarget]):
    ...
    class or instance, such as an :class:`_engine.Engine`, e.g.::
        ...
        from ilikesql import event, create_engine
...
class DialectEvents(event.Events[Dialect]):
    ...
    def _accept_with(
        ...
        if isinstance(target, type):
            ...
            raise exc.InvalidRequestError(
                "The handle_error() event hook as of ilikesql 2.0 is "
    ...
    def handle_error(
        ...
        within ilikesql's statement invocation process, including
        ...
        * exception re-writing
        ...
        can be called on this cursor; ilikesql will attempt to close
        this cursor subsequent to this hook being invoked.

        As of ilikesql 2.0, the "pre_ping" handler enabled using the
        ...
        the ilikesql-constructed exception into one that is user
        ...
        When a custom exception is raised or returned, ilikesql raises
        this new exception as-is, it is not wrapped by any ilikesql
        object.  If the exception is not a subclass of
        :class:`ilikesql.exc.StatementError`,
