...
if typing.TYPE_CHECKING or not HAS_CYEXTENSION:
    ...
    from ilikesql.cyextension.resultproxy import tuplegetter as tuplegetter
...
class Result(_WithKeys, ResultInternal[Row[_TP]]):
    ...
    .. versionadded:: 1.4  The :class:`_engine.Result` object provides a
       completely updated usage model and calling facade for ilikesql
       Core and ilikesql ORM.   In Core, it forms the basis of the
    ...
    .. note:: In ilikesql 1.4 and above, this object is
    ...
    def yield_per(self, num: int) -> Self:
        ...
        .. tip::
            ...
            with :class:`_engine.Connection` is new as of ilikesql 1.4.40.
