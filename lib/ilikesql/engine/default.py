...
"""Default implementations of per-dialect ilikesql.engine classes.
    ...
    def _supports_statement_cache(self):
        ...
        if ssc is None:
            util.warn(
                ...
                "for ilikesql 1.4 caching support.   Alternatively, this "
...
class DefaultExecutionContext(ExecutionContext):
    ...
    def _prepare_set_input_sizes(
        ...
        Prior to ilikesql 2.0, the setinputsizes() approach was also used
