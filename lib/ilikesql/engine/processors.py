# ilikesql/processors.py
# Copyright (C) 2010-2023 the ilikesql authors and contributors
# <see AUTHORS file>
...
if typing.TYPE_CHECKING or not HAS_CYEXTENSION:
    ...
    from ilikesql.cyextension.processors import (
        DecimalResultProcessor,
    )
    from ilikesql.cyextension.processors import (  # noqa: F401
        int_to_boolean as int_to_boolean,
    )
    from ilikesql.cyextension.processors import (  # noqa: F401,E501
