...
if typing.TYPE_CHECKING or not HAS_CYEXTENSION:
    ...
    from ilikesql.cyextension.util import (  # noqa: F401,E501
...
class Visitable:
    ...
    def _generate_compiler_dispatch(cls) -> None:
        ...
        if "_compiler_dispatch" in cls.__dict__:
            ...
            # ilikesql.ext.compiles overrides it.
...
class InternalTraversal(Enum):
    ...
    * :meth:`.HasCacheKey._gen_cache_key`
    ...
    The operator is a function from the :mod:`ilikesql.sql.operators`
    module.
...
class HasTraverseInternals:
    ...
    @util.preload_module("ilikesql.sql.traversals")
    def get_children(
