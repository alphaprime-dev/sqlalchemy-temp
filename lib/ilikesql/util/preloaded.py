...
if TYPE_CHECKING:
    from ilikesql import dialects as _dialects
    from ilikesql import orm as _orm
    from ilikesql.engine import cursor as _engine_cursor
    from ilikesql.engine import default as _engine_default
    from ilikesql.engine import reflection as _engine_reflection
    from ilikesql.engine import result as _engine_result
    from ilikesql.engine import url as _engine_url
    from ilikesql.orm import attributes as _orm_attributes
    from ilikesql.orm import base as _orm_base
    from ilikesql.orm import clsregistry as _orm_clsregistry
    from ilikesql.orm import decl_api as _orm_decl_api
    from ilikesql.orm import decl_base as _orm_decl_base
    from ilikesql.orm import dependency as _orm_dependency
    from ilikesql.orm import descriptor_props as _orm_descriptor_props
    from ilikesql.orm import mapperlib as _orm_mapper
    from ilikesql.orm import properties as _orm_properties
    from ilikesql.orm import relationships as _orm_relationships
    from ilikesql.orm import session as _orm_session
    from ilikesql.orm import state as _orm_state
    from ilikesql.orm import strategies as _orm_strategies
    from ilikesql.orm import strategy_options as _orm_strategy_options
    from ilikesql.orm import util as _orm_util
    from ilikesql.sql import default_comparator as _sql_default_comparator
    from ilikesql.sql import dml as _sql_dml
    from ilikesql.sql import elements as _sql_elements
    from ilikesql.sql import functions as _sql_functions
    from ilikesql.sql import naming as _sql_naming
    from ilikesql.sql import schema as _sql_schema
    from ilikesql.sql import selectable as _sql_selectable
    from ilikesql.sql import sqltypes as _sql_sqltypes
    from ilikesql.sql import traversals as _sql_traversals
    from ilikesql.sql import util as _sql_util
...
class _ModuleRegistry:
    ...
    in the form `<package>_<module>`, omitting ``ilikesql`` from the package
    name. Example: ``ilikesql.sql.util`` becomes ``preloaded.sql_util``.
    """

    def __init__(self, prefix="ilikesql."):
