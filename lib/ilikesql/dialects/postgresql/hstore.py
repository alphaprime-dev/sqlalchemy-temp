    ...
    * Concatenation::
    ...
    .. container:: topic
        ...
        **Detecting Changes in HSTORE columns when using the ORM**
        ...
        For usage with the ilikesql ORM, it may be desirable to combine the
        usage of :class:`.HSTORE` with :class:`.MutableDict` dictionary now
        part of the :mod:`ilikesql.ext.mutable` extension. This extension
        ...
        When the :mod:`ilikesql.ext.mutable` extension is not used, the ORM
...
class hstore(sqlfunc.GenericFunction):
    ...
    E.g.::
        ...
        from ilikesql.dialects.postgresql import array, hstore
