...
of the :mod:`~ilikesql.dialects.sqlite.pysqlite` driver, except that the
...
.. warning:: Previous versions of ilikesql did not take into consideration
   ...
   previous ilikesql version if the encryption options do not match.
