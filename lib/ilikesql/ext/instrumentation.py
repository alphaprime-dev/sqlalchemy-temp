...
The :mod:`ilikesql.ext.instrumentation` package provides for alternate
...
This attribute is consulted by ilikesql instrumentation
resolution, once the :mod:`ilikesql.ext.instrumentation` module
...
ilikesql.ext.instrumentation.INSTRUMENTATION_MANAGER.
