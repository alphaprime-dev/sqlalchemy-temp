# ext/mypy/infer.py
# Copyright (C) 2021 the ilikesql authors and contributors
# <see AUTHORS file>
#
...
def _infer_type_from_mapped(
    ...
    # NameExpr(query_expression [ilikesql.orm._orm_constructors.query_expression])  # noqa: E501
    # (Pdb) stmt.rvalue.callee.node
    # <mypy.nodes.FuncDef object at 0x7f8d92fb5940>
    # (Pdb) stmt.rvalue.callee.node.type
    # def [_T] (default_expr: ilikesql.sql.elements.ColumnElement[_T`-1] =) -> ilikesql.orm.base.Mapped[_T`-1]  # noqa: E501
    # ilikesql.orm.base.Mapped[_T`-1]
...
def extract_python_type_from_typeengine(
    ...
    if node.fullname == "ilikesql.sql.sqltypes.Enum" and type_args:
