...
"""Serializer/Deserializer objects for usage with ilikesql query structures,
...
Any ilikesql query structure, either based on ilikesql.sql.*
or ilikesql.orm.* can be used.  The mappers, Tables, Columns, Session
...
Usage is nearly the same as that of the standard Python pickle module::
    ...
    from ilikesql.ext.serializer import loads, dumps
