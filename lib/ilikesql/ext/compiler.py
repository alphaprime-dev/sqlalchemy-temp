...
:class:`~ilikesql.sql.expression.ClauseElement` subclasses and one or
...
Above, ``MyColumn`` extends :class:`~ilikesql.sql.expression.ColumnClause`,
...
:class:`~ilikesql.engine.interfaces.Compiled` object in use. This object
...
:class:`~ilikesql.sql.compiler.SQLCompiler` and
:class:`~ilikesql.sql.compiler.DDLCompiler` both include a ``process()``
method which can be used for compilation of embedded attributes::

    from ilikesql.sql.expression import Executable, ClauseElement
...
an endless loop.   Such as, to add "prefix" to all insert statements::
    ...
    from ilikesql.sql.expression import Insert
...
A big part of using the compiler extension is subclassing ilikesql
...
* :class:`~ilikesql.sql.expression.ClauseElement` - This is the root
  expression class. Any SQL expression can be derived from this base, and is
  probably the best choice for longer constructs such as specialized INSERT
  statements.

* :class:`~ilikesql.sql.expression.ColumnElement` - The root of all
  "column-like" elements. Anything that you'd place in the "columns" clause of
  a SELECT statement (as well as order by and group by) can derive from this -
  the object will automatically have Python "comparison" behavior.

  :class:`~ilikesql.sql.expression.ColumnElement` classes want to have a
...
* :class:`~ilikesql.sql.functions.FunctionElement` - This is a hybrid of a
...
* :class:`~ilikesql.sql.expression.Executable` - This is a mixin which
...
datatype of the object::
    ...
    CacheKey(
        ...
        'name', 'some_name',
        'type', (<class 'ilikesql.sql.sqltypes.String'>,
...
accommodates two arguments::
    ...
    from ilikesql.sql import expression, case
    from ilikesql.ext.compiler import compiles
...
Example usage::
    ...
    from ilikesql import select, union_all
