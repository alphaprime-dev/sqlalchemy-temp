...
constructed using the :func:`.ordering_list` factory::
    ...
    from ilikesql.ext.orderinglist import ordering_list
...
.. warning::
  ...
  that are unsupported or are problematic include:
    ...
    * an entry must be deleted in order to make room for a new entry.
      ilikesql's unit of work performs all INSERTs before DELETEs within a
...
class OrderingList(List[_T]):
    ...
    def __init__(
        ...
        :param reorder_on_append:
          ...
          ilikesql will add instances to the list via append() when your
