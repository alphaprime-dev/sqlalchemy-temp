...
def outparam(
    ...
    :class:`~ilikesql.engine.CursorResult` object via its ``out_parameters``
...
def bindparam(
    ...
    In ilikesql, the :func:`.bindparam` construct has
    ...
    ilikesql's Core expression system makes wide use of
    ...
    :param quote:
      ...
      currently known as a ilikesql reserved word; this currently
    ...
    :param literal_execute:
      ...
      with a special "POSTCOMPILE" token, and the ilikesql compiler will
...
def case(
    *whens: Union[
    ...
    as in::
        ...
        from ilikesql import case, literal_column
...
def try_cast(
    ...
    In ilikesql, this construct is supported **only** by the SQL Server
    ...
    .. tip:: As :func:`_sql.try_cast` originates from the SQL Server dialect,
       it's importable both from ``ilikesql.`` as well as from
       ``ilikesql.dialects.mssql``.
    ...
    E.g.::
        ...
        from ilikesql import select, try_cast, Numeric
...
def distinct(expr: _ColumnExpressionArgument[_T]) -> UnaryExpression[_T]:
    ...
    as in::
        ...
        from ilikesql import distinct, func
...
def funcfilter(
    ...
    E.g.::
        ...
        from ilikesql import funcfilter
...
def nulls_first(column: _ColumnExpressionArgument[_T]) -> UnaryExpression[_T]:
    ...
    should be handled when they are encountered during ordering::
        ...
        from ilikesql import desc, nulls_first
...
def nulls_last(column: _ColumnExpressionArgument[_T]) -> UnaryExpression[_T]:
    ...
    should be handled when they are encountered during ordering::
        ...
        from ilikesql import desc, nulls_last
...
def text(text: str) -> TextClause:
    ...
    ilikesql type constructs to play a role when executing
...
def tuple_(
    *clauses: _ColumnExpressionArgument[Any],
    ...
    .. warning::
        ...
        :class:`~ilikesql.exc.DBAPIError` when such an expression is
        invoked.
