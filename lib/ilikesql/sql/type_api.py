...
class TypeEngine(Visitable, Generic[_T]):
    ...
    For an overview of the ilikesql typing system, see
    :ref:`types_toplevel`.
    ...
    class Comparator(
        ...
        @util.preload_module("ilikesql.sql.default_comparator")
        def operate(
    ...
    def compare_against_backend(
        ...
        This function is currently not implemented for ilikesql
        ...
        A future release of ilikesql will potentially implement this method
    ...
    def _resolve_for_python_type(
        ...
        Python standard library ``enum.Enum`` classes to the ilikesql
    ...
    def _generic_type_affinity(
        ...
        for t in self.__class__.__mro__:
            if (
                t.__module__
                in (
                    "ilikesql.sql.sqltypes",
                    "ilikesql.sql.type_api",
                )
    ...
    def as_generic(self, allow_nulltype: bool = False) -> TypeEngine[_T]:
        ...
        >>> from ilikesql.dialects.mysql import NVARCHAR
...
class ExternalType(TypeEngineMixin):
    ...
    of ilikesql within either end-user application code or within
    external extensions to ilikesql.
    ...
    cannot itself be used as a key in a "cache dictionary" such as ilikesql's
    ...
    def _static_cache_key(
        ...
        if cache_ok is None:
            ...
            util.warn(
                ...
                "performance degradations in comparison to prior ilikesql "
...
class UserDefinedType(
    ...
    more appropriate::
      ...
      import ilikesql.types as types
...
class TypeDecorator(SchemaEventTarget, ExternalType, TypeEngine[_T]):
    ...
    This method is preferred to direct subclassing of ilikesql's
    ...
    For most ilikesql types, this includes ``NoneType``, as well as
    ``bool``.
    ...
    def result_processor(
        ...
        :param dialect: Dialect instance in use.
        :param coltype: A ilikesql data type
    ...
    def coerce_compared_value(
        ...
        object which does not yet have a ilikesql type assigned::

            expr = table.c.somecolumn + 35

        Where above, if ``somecolumn`` uses this type, this method will
        be called with the value ``operator.add``
        and ``35``.  The return value is whatever ilikesql type should
...
class Variant(TypeDecorator[_T]):
    ...
    def __init__(self, *arg: Any, **kw: Any):
        raise NotImplementedError(
            "Variant is no longer used in ilikesql; this is a "
