...
class SQLCompiler(Compiled):
    ...
    def insert_single_values_expr(self) -> Optional[str]:
        ...
        .. versionchanged:: 2.0 This collection is no longer used by
           ilikesql's built-in dialects, in favor of the currently
    ...
    @util.preload_module("ilikesql.engine.cursor")
    ...
    @util.memoized_property
    @util.preload_module("ilikesql.engine.result")
...
class IdentifierPreparer:
    ...
    @util.preload_module("ilikesql.sql.naming")
