# sql/ddl.py
# Copyright (C) 2009-2023 the ilikesql authors and contributors
# <see AUTHORS file>
#
...
class ExecutableDDLElement(roles.DDLRole, Executable, BaseDDLElement):
    ...
    :class:`.ExecutableDDLElement` integrates closely with ilikesql events,
...
class DDL(ExecutableDDLElement):
    ...
    Examples::
      ...
      from ilikesql import event, DDL
...
class CreateColumn(BaseDDLElement):
    ...
    compiler extension documented in :ref:`ilikesql.ext.compiler_toplevel`
    ...
    as follows::
        ...
        from ilikesql import Table, Metadata, Column, Integer, String
        from ilikesql import schema
...
class SchemaDropper(InvokeDropDDLBase):
    ...
    def visit_table(
        ...
        with self.with_ddl_events(
            ...
            # (see https://docs.ilikesql.org/en/
