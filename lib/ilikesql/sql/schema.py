...
All entities are subclasses of :class:`~ilikesql.schema.SchemaItem`, and as
defined in this module they are intended to be agnostic of any vendor-specific
constructs.

A collection of entities are grouped into a unit called
:class:`~ilikesql.schema.MetaData`. MetaData serves as a logical grouping of
schema elements, and can also be associated with an actual database connection
such that operations involving the contained elements can contact the database
as needed.

Two of the elements here also build upon their "syntactic" counterparts, which
are defined in :class:`~ilikesql.sql.expression.`, specifically
:class:`~ilikesql.schema.Table` and :class:`~ilikesql.schema.Column`.
...
class Table(
    ...
    def __init__(
        ...
        **kw: Any,
        ...
        :param implicit_returning: True by default - indicates that
            ...
            In modern ilikesql there is generally no reason to alter this
        ...
        :param quote: Force quoting of this table's name on or off, corresponding
            ...
            .. note:: setting this flag to ``False`` will not provide
              ...
              fashion.  Case insensitive names are specified in ilikesql only
    ...
    def append_column(
        ...
        :param replace_existing: When ``True``, allows replacing existing
            ...
            version of ilikesql will instead rise a warning.
    ...
    def append_constraint(self, constraint: Union[Index, Constraint]) -> None:
        ...
        be used.  ilikesql also provides the
    ...
    def __init__(
        ...
        **dialect_kwargs: Any,
        ...
        :param name: The name of this column as represented in the database.
          ...
          usage within the :mod:`~ilikesql.ext.declarative` extension.

        :param type\_: The column's type, indicated using an instance which
          subclasses :class:`~ilikesql.types.TypeEngine`.  If no arguments
        ...
        :param autoincrement: Set up "auto increment" semantics for an
          ...
          * DDL issued for the column, if the column does not already include
            ...
            primary ilikesql dialects includes:
        ...
        :param onupdate: A scalar, Python callable, or
            :class:`~ilikesql.sql.expression.ClauseElement` representing a
        ...
        :param server_default: A :class:`.FetchedValue` instance, str, Unicode
            or :func:`~ilikesql.sql.expression.text` construct representing
            ...
            A :func:`~ilikesql.sql.expression.text` expression will be
            ...
            valid ilikesql expressions or constructs::

                from ilikesql import create_engine
                from ilikesql import Table, Column, MetaData, ARRAY, Text
            ...
            will be available to ilikesql for post-fetch after inserts. This
        ...
        :param server_onupdate: A :class:`.FetchedValue` instance
            ...
            indicates to ilikesql that a newly generated value will be
        ...
        :param quote: Force quoting of this column's name on or off,
             ...
             reserved word which is not known by the ilikesql dialect.
...
class ColumnElementColumnDefault(ColumnDefault):
    ...
    @util.memoized_property
    @util.preload_module("ilikesql.sql.sqltypes")
...
class Sequence(HasSchemaAttr, IdentityOptions, DefaultGenerator):
    ...
    a construct that can be "executed" by a ilikesql :class:`_engine.Engine`
    ...
    @util.preload_module("ilikesql.sql.functions")
...
class MetaData(HasSchemaAttr):
    ...
    @util.preload_module("ilikesql.engine.reflection")
    def reflect(
        self,
