...
class Operators:
    ...
    :meth:`~ilikesql.sql.operators.Operators.operate` and
    :meth:`~ilikesql.sql.operators.Operators.reverse_operate`, as well as
    :meth:`~ilikesql.sql.operators.Operators.__and__`,
    :meth:`~ilikesql.sql.operators.Operators.__or__`,
    :meth:`~ilikesql.sql.operators.Operators.__invert__`.
    ...
    def op(
        ...
        :param precedence: precedence which the database is expected to apply
         ...
         .. seealso::
            ...
            of how the ilikesql SQL compiler renders parenthesis
...
class custom_op(OperatorType, Generic[_T]):
    ...
    to represent the "factorial" operation::
        ...
        from ilikesql.sql import UnaryExpression
...
class ColumnOperators(Operators):
    ...
    a ilikesql-specific operator function from
    :mod:`ilikesql.expression.operators`.   For example
    the ``__eq__`` function::
    ...
    def __lshift__(self, other: Any) -> ColumnOperators:
        ...
        Not used by ilikesql core, this is provided
