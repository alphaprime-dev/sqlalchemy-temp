...
class FunctionElement(Executable, ColumnElement[_T], FromClause, Generative):
    ...
    def columns(self):
        ...
        .. sourcecode:: pycon+sql
            ...
            >>> from ilikesql import column, select, func
    ...
    def alias(self, name=None, joins_implicitly=False):
        ...
        .. sourcecode:: pycon+sql
            ...
            >>> from ilikesql import func, select, column
...
class _FunctionGenerator:
    ...
    ilikesql, it will be rendered exactly as is. For common SQL functions
    which ilikesql is aware of, the name may be interpreted as a *generic
    ...
    ilikesql can be made aware of the return type of functions to enable
    type-specific lexical and result-based behavior. For example, to ensure
    that a string-based function returns a Unicode value and is similarly
    treated as a string in expressions, specify
    :class:`~ilikesql.types.Unicode` as the type:
    ...
    but are not exactly the same as "functions" from a ilikesql
    perspective.
...
class GenericFunction(Function[_T]):
    ...
    on or off for the name, use the :class:`.ilikesql.sql.quoted_name`
    construct::
...
class now(GenericFunction[datetime.datetime]):
    ...
    ilikesql dialects will usually render this particular function
...
class concat(GenericFunction[str]):
    ...
    String concatenation in ilikesql is more commonly available using the
