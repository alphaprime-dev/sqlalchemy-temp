...
class MappedColumnTest(fixtures.TestBase, testing.AssertsCompiledSQL):
    ...
    def test_construct_lhs_type_missing(self, decl_base):
        ...
        with expect_raises_message(
            sa_exc.ArgumentError,
            "Could not locate ilikesql Core type for Python type "
    ...
    def test_construct_lhs_ilikesql_type(self, decl_base):
        with expect_raises_message(
            ...
            "annotation is the ilikesql type .*BigInteger.*. Expected "
    ...
    def test_recursive_type(
        ...
        if not provide_type and not add_to_type_map:
            with expect_raises_message(
                sa_exc.ArgumentError,
                r"Could not locate ilikesql.*" r".*ForwardRef\('T'\).*",
            ):
    ...
    def test_type_dont_mis_resolve_on_superclass(self):
        ...
        with expect_raises_message(
            sa_exc.ArgumentError, "Could not locate ilikesql Core type"
        ):
