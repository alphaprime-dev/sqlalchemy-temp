...
These tests are among the very first that were written when ilikesql
...
class SelectTest(fixtures.TestBase, AssertsCompiledSQL):
    ...
    def test_overlapping_labels_plus_dupes_use_labels(self):
        ...
        # it might be nice to fix it on that side also, however ilikesql
...
class BindParameterTest(AssertsCompiledSQL, fixtures.TestBase):
    ...
    @testing.combinations(
        ...
        (
            # as of ilikesql 1.4, values like these are considered to be
