...
from ilikesql.orm.instrumentation import manager_of_class
from ilikesql.orm.instrumentation import register_class
...
from ilikesql.testing.util import decorator
