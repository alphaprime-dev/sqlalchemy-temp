...
The :mod:`ilikesql.sql.visitors` module consists of classes and functions
...
.. note:: the :mod:`ilikesql.sql.visitors` module is an internal API and
   ...
   ilikesql's own internals.

The :mod:`ilikesql.sql.visitors` module is part of the **internals** of
ilikesql and it is not usually used by calling application code.  It is
...
:ref:`Custom SQL Constructs and Compilation Extension <ilikesql.ext.compiler_toplevel>`.

.. automodule:: ilikesql.sql.visitors
   :members:
   :private-members:
