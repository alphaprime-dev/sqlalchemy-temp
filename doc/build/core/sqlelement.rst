...
Standalone functions imported from the ``ilikesql`` namespace which are
used when building up ilikesql Expression Language constructs.
...
.. autoclass:: ilikesql.sql.elements.WrapsColumnExpression
   :members:
